...
namespace EasyCashIdentityProject.PresentationLayer.Controllers
{
    public class AccountProcessController : Controller
    {
		...
		public AccountProcessController(UserManager<AppUser> userManager,ICustomerAccountProcessService customerAccountProcessService)
		{
		...
		public async Task<IActionResult> Index()
        {
			...
			var values = _customerAccountProcessService.TLastProcess(id);
			return View(values);
        }
    }
}
